...
def gameplay_tick(args)
    ...
    args.state.goodies ||= [
       { x: 27, y: 14, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 32, y: 14, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 37, y: 18, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 37, y: 23, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 32, y: 27, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 27, y: 27, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 22, y: 18, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
       { x: 22, y: 23, type: GOODIES[:guard].name, sprite = 'sprites/halfling.png', hp: GOODIES[:guard].hp, atk: GOODIES[:guard].atk},
     ]
    ...
    #render the village
    # args.outputs.sprites << args.state.goodies
  ...
  def spawn_cloud(args)
    ...
    {
      x: x_spot,
      y: rand(args.grid.h - size - args.state.grid.padding_y),
      w: size,
      h: size,
      path: sprite,
    }
