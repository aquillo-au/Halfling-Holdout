...
def gameplay_tick(args)
    ...
    args.state.walls = [
      { x: 19, y: 14, tile_key: :wall },
      { x: 19, y: 15, tile_key: :wall },
      { x: 19, y: 16, tile_key: :wall },
      { x: 19, y: 17, tile_key: :wall },
      { x: 19, y: 24, tile_key: :wall },
      { x: 19, y: 25, tile_key: :wall },
      { x: 19, y: 26, tile_key: :wall },
      { x: 19, y: 27, tile_key: :wall },
      { x: 18, y: 27, tile_key: :wall },
    ]
