...
def gameplay_tick(args)
    ...
    args.state.walls = [
      ...
      { x: 22, y: 27, tile_key: :wall },

      { x: 23, y: 27, tile_key: :wall },
      { x: 24, y: 27, tile_key: :wall },
      { x: 25, y: 27, tile_key: :wall },
      { x: 26, y: 27, tile_key: :wall },

      { x: 33, y: 27, tile_key: :wall },
      { x: 34, y: 27, tile_key: :wall },
      { x: 35, y: 27, tile_key: :wall },
      { x: 36, y: 27, tile_key: :wall },

      { x: 37, y: 27, tile_key: :wall },
      ...
      { x: 36, y: 14, tile_key: :wall },
      { x: 35, y: 14, tile_key: :wall },
      { x: 34, y: 14, tile_key: :wall },
      { x: 33, y: 14, tile_key: :wall },

      { x: 23, y: 14, tile_key: :wall },
      { x: 24, y: 14, tile_key: :wall },
      { x: 25, y: 14, tile_key: :wall },
      { x: 26, y: 14, tile_key: :wall },
    ]
